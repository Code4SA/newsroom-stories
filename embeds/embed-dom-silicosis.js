...
if (document.location.hostname == "localhost") {
  ...
  var baseurl = "https://static.code4sa.org/newsroom-stories";
}

var container = document.getElementById('/2016/11/18/silicosis');

var pymParentScript = document.createElement( 'script' );
pymParentScript.type = 'text/javascript';
pymParentScript.text = "var pymParent = new pym.Parent('/2016/11/18/silicosis', '"
  + baseurl + "/2016/11/18/silicosis.html', {});";
